    ...
    <div className="space-y-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <ProcessingCard className="p-8">
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-6">
              <Save className="h-6 w-6 text-winter-blue-600 dark:text-winter-blue-400" />
              <h4 className="text-xl font-semibold text-winter-blue-900 dark:text-winter-blue-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center p-4 bg-gradient-to-br from-winter-blue-50 to-winter-blue-100 dark:from-winter-blue-950 dark:to-winter-blue-900 rounded-xl border border-winter-blue-200 dark:border-winter-blue-800">
                ...
                <div className={cn("text-2xl font-bold tabular-nums mb-1", getVolumeColor())}>
                  {Math.round(localVolume * 100)}%
                </div>
                <div className="text-sm text-winter-blue-600 dark:text-winter-blue-400 font-medium">
                  Current Volume
                </div>
              </div>
              ...
              <div className="text-center p-4 bg-gradient-to-br from-warm-amber-50 to-warm-amber-100 dark:from-warm-amber-950 dark:to-warm-amber-900 rounded-xl border border-warm-amber-200 dark:border-warm-amber-800">
                <div className="flex items-center justify-center mb-3">
                  <AudioIcon size="lg" className="text-warm-amber-600 dark:text-warm-amber-400" />
                </div>
                <div className="text-2xl font-bold tabular-nums mb-1 text-warm-amber-600 dark:text-warm-amber-400">
                  {fileCount}
                </div>
                <div className="text-sm text-warm-amber-600 dark:text-warm-amber-400 font-medium">
                  Audio Files
                </div>
              </div>
            ...
            {/* Additional Info */}
            <div className="bg-gradient-to-r from-ice-gray-50 to-ice-gray-100 dark:from-ice-gray-900 dark:to-ice-gray-800 rounded-xl p-6 border border-ice-gray-200 dark:border-ice-gray-700">
              <div className="flex items-start gap-4">
                <div className="p-2 rounded-full bg-ice-gray-200 dark:bg-ice-gray-700">
                  <InfoIconComponent size="sm" className="text-ice-gray-600 dark:text-ice-gray-400" />
                </div>
                <div className="space-y-2">
                  <h5 className="font-semibold text-ice-gray-900 dark:text-ice-gray-100">
                    Smart Configuration
                  </h5>
                  <div className="text-sm text-ice-gray-600 dark:text-ice-gray-400 space-y-1">
                    <p>• Your volume setting is automatically saved for future sessions</p>
                    <p>• All {fileCount} MP3 files will be processed with consistent volume</p>
                    <p>• You can preview the result before final processing</p>
                    <p>• Settings can be adjusted anytime during the preview phase</p>
                  </div>
                </div>
              </div>
            </div>
